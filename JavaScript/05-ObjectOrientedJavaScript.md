...
The properties allow us to keep track of the state of the object and the methods allow us to manipulate the state of the object to model the real world.
